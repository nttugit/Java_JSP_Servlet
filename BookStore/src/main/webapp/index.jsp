<%@page import="model.Customer" %>
        ...
        <body>
            <% String path=request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() +
                ...
                <% String username=(request.getAttribute("username") !=null) ? request.getAttribute("username") + ""
                    ...
                    + "" : "" ; String loginError=(request.getAttribute("loginError") !=null) ?
                    request.getAttribute("loginError") + "" : "" ; %>

                    <% Customer customer=session.getAttribute("customer") !=null ? (Customer)
                        session.getAttribute("customer") : null; String userFirstName="" ; if (customer !=null) { String
                        arr[]=customer.getFullName().split(" ");
	...
	<nav class=" navbar navbar-expand-lg bg-body-tertiary">
                        <div class="container-fluid">
                            <a class="navbar-brand" href="#"> <img src="./img/logo.png" alt="Bootstrap" height="24">
                            </a>
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                    <li class="nav-item"><a class="nav-link active" aria-current="page"
                                            href="<%= path %>/index.jsp">Trang chủ</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="list-group">
                                        ...
                                        <button type="button" class="list-group-item list-group-item-action">Thời trang
                                            nam</button>
                                        <button type="button" class="list-group-item list-group-item-action">Thời trang
                                            nữ</button>
                                        ...
                                        <button type="button" class="list-group-item list-group-item-action">Thời trang
                                            trung niên</button>
                                        <button type="button" class="list-group-item list-group-item-action">Dành cho
                                            bé</button>
                                    </div>
                                </div>
                                <!-- End Sidebar -->
                                        ...
                                        <form action="login" method="POST">
                                            ...
                                            <div class="mb-3">
                                                <label for="username" class="col-form-label">Tên đăng
                                                    ...
                                                    name="username" value="<%=loginError != "" ? username : ""%>"
                                                    required>
                                            </div>
                                            <div class="mb-3">
