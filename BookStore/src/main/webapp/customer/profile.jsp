...
<body>
	...
	String isUpdatePassword = (request.getAttribute("isUpdatePassword") != null)
			? request.getAttribute("isUpdatePassword") + ""
			: "";
	String noMatchPasswordError = (request.getAttribute("noMatchPasswordError") != null)
			? request.getAttribute("noMatchPasswordError") + ""
			: "";
	String wrongPasswordError = (request.getAttribute("wrongPasswordError") != null)
			? request.getAttribute("wrongPasswordError") + ""
			: "";
	String expiredSessionError = (request.getAttribute("expiredSessionError") != null)
			? request.getAttribute("expiredSessionError") + ""
			: "";
	String updatePasswordMsg = (request.getAttribute("updatePasswordMsg") != null)
	...
	String isUpdateNotification = (request.getAttribute("isUpdateNotification") != null)
			? request.getAttribute("isUpdateNotification") + ""
			: "";
	String updateNotificationMsg = (request.getAttribute("updateNotificationMsg") != null)
		...
		<div class="">
			<h2 class="text-center">
				...
				<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
					<li class="nav-item" role="presentation">
						<button class="nav-link active" id="pills-update-profile-tab"
							...
							type="button" role="tab" aria-controls="pills-update-profile"
							aria-selected="true">Hồ sơ</button>
					</li>
					<li class="nav-item" role="presentation">
						<button class="nav-link" id="pills-update-password-tab"
							data-bs-toggle="pill" data-bs-target="#pills-update-password"
							type="button" role="tab" aria-controls="pills-update-password"
							aria-selected="false">Đổi mật khẩu</button>
					</li>
					<li class="nav-item" role="presentation">
						<button class="nav-link" id="pills-update-notification-tab"
							data-bs-toggle="pill" data-bs-target="#pills-update-notification"
							type="button" role="tab"
							aria-controls="pills-update-notification" aria-selected="false">Cài
				...
				<div class="tab-content" id="pills-tabContent">
					...
					<div class="tab-pane fade show active" id="pills-update-profile"
						...
						<div class="row">
								...
								<form action="customer" class="form" method="POST">
									...
									<div class="mb-3">
										...
										<span class="red">*</span> <input type="text"
											...
											value="<%=customer.getUsername()%>" disabled>
									</div>
									<div class="mb-3">
									...
									<div class="mb-3">
										<label for="sex" class="form-label">Giới tính</label> <select
											...
											<option value="1"
												<%=(customer.getSex() == 1) ? "selected" : ""%>>Nam
											</option>
											<option value="0"
												<%=(customer.getSex() == 0) ? "selected" : ""%>>Nữ
											</option>
											<option value="2"
												<%=(customer.getSex() == 2) ? "selected" : ""%>>Khác
											</option>
										</select>
									</div>
									<div class="mb-3">
							...
							<div class="right-image col-6">
								<img
									src="https://top-10.vn/wp-content/uploads/2021/10/2-8.png.webp"
									alt="">
							</div>
						</div>
					...
					<!-- TAB 2: ĐỔI MẬT KHẨU -->
					<span id="isUpdatePassword" hidden> <%=isUpdatePassword%>
					</span>
								...
								<form action="customer" class="form" method="POST">
									...
									<div class="mb-3">
										<label for="password" class="form-label">Nhập mật khẩu
											cũ</label> <span class="red">* <%=wrongPasswordError%>
										</span> <input type="password" class="form-control" id="password"
											name="password" required>
									</div>
									<div class="mb-3">
										<label for="newPassword" class="form-label">Nhập mật
											khẩu mới khẩu</label> <span class="red">*</span> <input
											type="password" class="form-control" id="newPassword"
											name="newPassword" required>
									</div>
									<div class="mb-3">
										<label for="repeatPassword" class="form-label">Nhập
											lại mật khẩu</label> <span class="red">* <%=noMatchPasswordError%>
					...
					<span id="isUpdateNotification" hidden> <%=isUpdateNotification%>
					</span>
					<div class="tab-pane fade" id="pills-update-notification"
						...
						<div class="row">
								...
								<form action="customer" class="form" method="POST">
									...
									<div class="mb-3">
										...
										<input type="checkbox" class="form-check-input"
											...
											<%=customer.isRegisteredNotification() != false ? "checked" : "unchecked"%>>
									</div>
									<button type="submit" class="btn btn-success"
							...
							<div class="right-image col-6">
								<img
									src="https://product.hstatic.net/200000017360/product/bia-1_ong-gia-va-bien-ca_615e3ecae186401ea06865301bce1a21_master.png"
									alt="">
							</div>
						</div>
					</div>
