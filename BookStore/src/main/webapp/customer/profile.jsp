											...
											<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
												...
												<li class="nav-item" role="presentation">
													<button class="nav-link" id="pills-update-notification-tab"
														...
														aria-selected="false">Cài đặt thông báo</button>
												</li>
											</ul>
															...
															<form action="customer" class="form" method="POST">
																...
																<div class="mb-3">
																	<label for="fullName" class="form-label">Họ và
																		tên</label> <span class="red">*</span> <input
																...
																<div class="mb-3">
																	<label for="phone" class="form-label">Số điện
																		thoại</label> <span class="red">*</span> <input
																...
																<div class="mb-3">
																	<label for="address" class="form-label">Địa
																		chỉ</label> <span class="red">*</span> <input
															...
															<form action="customer" class="form" method="POST">
																...
																<div class="mb-3">
																	<label for="newPassword" class="form-label">Nhập mật
																		khẩu mới khẩu</label> <span class="red">*</span>
