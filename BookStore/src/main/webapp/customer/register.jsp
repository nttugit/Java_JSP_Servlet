<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	<body>
		...
		<% String errorMsg=(request.getAttribute("errorMsg") !=null) ? request.getAttribute("errorMsg") + "" : "" ;
			...
			request.getAttribute("repeatPassword") + "" : "" ; String fullName=(request.getAttribute("fullName") !=null)
			? request.getAttribute("fullName") + "" : "" ; String phone=(request.getAttribute("phone") !=null) ?
			request.getAttribute("phone") + "" : "" ; String address=(request.getAttribute("address") !=null) ?
			request.getAttribute("address") + "" : "" ; String email=(request.getAttribute("email") !=null) ?
			request.getAttribute("email") + "" : "" ; String sex=(request.getAttribute("sex") !=null) ?
			request.getAttribute("sex") + "" : "" ; String dob=(request.getAttribute("dob") !=null) ?
			request.getAttribute("dob") + "" : "" ; String termsConsent=(request.getAttribute("termsConsent") !=null) ?
			...
			<% String registerMsg=(request.getAttribute("registerMsg") !=null) ? request.getAttribute("registerMsg")
				+ "" : "" ; %>
				<!-- Header -->
									...
									<form action="<%= path %>/customer" class="form" method="POST">
										...
										<div class="mb-3">
											<label for="phone" class="form-label">Số điện thoại</label> <span
												class="red">*</span> <input type="text" class="form-control" id="phone"
										...
										<div class="mb-3">
											<label for="email" class="form-label">Email</label> <span
												class="red">*</span> <input type="email" class="form-control" id="email"
												name="email" value="<%=email%>" required>
										</div>
										<div class="mb-3">
											<label for="sex" class="form-label">Giới tính</label> <select name="sex"
										...
										<div class="mb-3">
											<label for="dob" class="form-label">Ngày sinh</label> <input name="dob"
												id="dob" type="date" class="form-control" value="<%=dob%>">
                            ...
                            <input type="text" class="form-control" id="deliveryAddress" name="deliveryAddress">
										...
										<div class="mb-3">
											...
											<input type="checkbox" class="form-check-input" id="termsConsent"
												name="termsConsent" <%=termsConsent !="" ? "checked" : "unchecked" %>
											required>
										</div>
										<div class="mb-3">
