    ...
    <body>
        <% String path=request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() +
            ...
            <% String errorMsg=(request.getAttribute("errorMsg") !=null) ? request.getAttribute("errorMsg") + "" : "" ;
                ...
                request.getAttribute("repeatPassword") + "" : "" ; String fullName=(request.getAttribute("fullName")
                !=null) ? request.getAttribute("fullName") + "" : "" ; String phone=(request.getAttribute("phone")
                !=null) ? request.getAttribute("phone") + "" : "" ; String address=(request.getAttribute("address")
                !=null) ? request.getAttribute("address") + "" : "" ; String email=(request.getAttribute("email")
                !=null) ? request.getAttribute("email") + "" : "" ; String sex=(request.getAttribute("sex") !=null) ?
                request.getAttribute("sex") + "" : "" ; String dob=(request.getAttribute("dob") !=null) ?
                request.getAttribute("dob") + "" : "" ; String termsConsent=(request.getAttribute("termsConsent")
