                                    ...
                                    <div class="container">
                                        <div class="">
                                            ...
                                            <nav aria-label="breadcrumb">
                                                <ol class="breadcrumb">
                                                    <li class="breadcrumb-item"><a href="<%= path %>/">Trang chủ</a>
                                                    </li>
                                            ...
                                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link" id="pills-update-notification-tab"
                                                        ...
                                                        aria-selected="false">Cài đặt thông
                                                        báo</button>
                                                </li>
                                            </ul>
                                            <div class="tab-content" id="pills-tabContent">
                                                ...
                                                <div class="tab-pane fade show active" id="pills-update-profile"
                                                    ...
                                                    <div class="row">
                                                        <div class="user_info col-6">
                                                            <form action="update-profile" class="form" method="POST">
                                                            ...
                                                            customer.getUsername() %>" disabled>
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <span class="red">*</span>
                                                                    <input type="text" class="form-control"
                                                                        id="fullName" name="fullName" required value="<%= 
                                                ...
                                                <div class="tab-pane fade" id="pills-update-password" role="tabpanel"
                                                    ...
                                                    <div class="row">
                                                        <div class="user_info col-6">
                                                            <form action="update-password" class="form" method="POST">
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="password" class="form-label">Nhập mật
                                                                        khẩu
                                                                        cũ</label>
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="repeatPassword" class="form-label">Nhập
                                                                        ...
                                                                        mật
                                                                        khẩu</label>
                                                                    <span class="red">* <%= noMatchPasswordError %>
                                                                    </span>
                                                                    <input type="password" class="form-control"
                                                ...
                                                <div class="tab-pane fade" id="pills-update-notification"
                                                    ...
                                                    <div class="row">
                                                        <div class="user_info col-6">
                                                            <form action="update-notification" class="form"
                                                                method="POST">
